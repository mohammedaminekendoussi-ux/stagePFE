...
<body>
    ...
    <div class="filters">
        ...
        @if($rapportData->filtres['date_debut'] ?? false) Du: {{ $rapportData->filtres['date_debut'] }} @endif
        @if($rapportData->filtres['date_fin'] ?? false) Au: {{ $rapportData->filtres['date_fin'] }} @endif
    </div>
